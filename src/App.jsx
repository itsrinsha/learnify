...
const DashboardLayout = lazy(() =>
  import("./components/student/DashboardLayout")
);
...
const BuyCourses = lazy(() =>
  import("./pages/Student/BuyCourses")
);
const LiveClasses = lazy(() =>
  import("./pages/Student/LiveClasses")
);
const StudentMessage = lazy(() =>
  import("./pages/Student/StudentMessage")
);
const Exams = lazy(() =>
...
const CourseDetails = lazy(() =>
  import("./pages/Student/CourseDetails")
);
const CoursePlayer = lazy(() =>
  import("./pages/Student/CoursePlayer")
);
const LiveRoom = lazy(() =>
  import("./pages/Student/LiveRoom")
);
const StudentReviews = lazy(() =>
  import("./pages/Student/StudentReviews")
);

// Instructor Dashboard Components
const InstructorLayout = lazy(() =>
  import("./components/instructor/InstructorLayout")
);
...
const MyCourses = lazy(() =>
  import("./pages/Instructor/MyCourses")
);
const CreateCourse = lazy(() =>
  import("./pages/Instructor/CreateCourse")
);
const StudentsList = lazy(() =>
  import("./pages/Instructor/StudentsList")
);
const StudentDetails = lazy(() =>
  import("./pages/Instructor/StudentDetails")
);
const InstructorReviews = lazy(() =>
  import("./pages/Instructor/InstructorReviews")
);
const InstructorLiveClasses = lazy(() =>
  import("./pages/Instructor/InstructorLiveClasses")
);
const InstructorMessages = lazy(() =>
  import("./pages/Instructor/InstructorMessages")
);
const InstructorAttendance = lazy(() =>
  import("./pages/Instructor/InstructorAttendance")
);
const InstructorOffers = lazy(() =>
  import("./pages/Instructor/InstructorOffers")
);
const InstructorPayments = lazy(() =>
  import("./pages/Instructor/InstructorPayments")
);
const InstructorEarnings = lazy(() =>
  import("./pages/Instructor/InstructorEarnings")
);
const InstructorExams = lazy(() =>
  import("./pages/Instructor/InstructorExams")
);
const InstructorVerification = lazy(() =>
  import("./pages/Instructor/InstructorVerification")
);
const InstructorPendingApproval = lazy(() =>
  import("./pages/Instructor/InstructorPendingApproval")
);
...
const AdminInstructors = lazy(() =>
  import("./pages/admin/AdminInstructors")
);
...
const AdminLiveClasses = lazy(() =>
  import("./pages/admin/AdminLiveClasses")
);
const AdminInstructorAvailability = lazy(() =>
  import("./pages/admin/AdminInstructorAvailability")
);
const AdminPayments = lazy(() =>
  import("./pages/admin/AdminPayments")
);
const AdminEarnings = lazy(() =>
  import("./pages/admin/AdminEarnings")
);
const AdminUserBlocks = lazy(() =>
  import("./pages/admin/AdminUserBlocks")
);
      ...
      <Suspense fallback={<LoadingSpinner />}>
        <Routes>
          ...
          >
            ...
            <Route
              path="availability"
              element={<AdminInstructorAvailability />}
            />
